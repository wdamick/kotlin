...
import org.jetbrains.kotlin.cli.jvm.compiler.FileLocator;
...
public class JVMConfigurationKeys {
    ...
    public static final CompilerConfigurationKey<FileLocator> FILE_LOCATOR =
            CompilerConfigurationKey.create("File locator service");
