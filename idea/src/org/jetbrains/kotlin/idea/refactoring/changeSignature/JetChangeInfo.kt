...
public class JetChangeInfo(
    ...
    public val isParameterSetOrOrderChanged: Boolean by Delegates.lazy {
        val signatureParameters = getNewSignatureParameters()
    ...
    public fun getNewSignatureParametersCount(): Int = newParameters.size() - (if (receiverParameterInfo != null) 1 else 0)

    public fun getNewSignatureParameters(): List<JetParameterInfo> {
    ...
    public fun getOrCreateJavaChangeInfo(): JavaChangeInfo? {
        if (javaChangeInfo == null) {
            ...
            val newParameterList = receiverParameterInfo.singletonOrEmptyList() + getNewSignatureParameters()
